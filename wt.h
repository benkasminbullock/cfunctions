...
void do_void_pointer (cfparse_t * cfp, const char * text, int yyleng);
void do_start_arguments (cfparse_t *);
void do_arguments (cfparse_t * cfp, const char * yytext, int yyleng);
void do_function_pointer (cfparse_t * cfp, const char * text, int yyleng);
void do_function_pointer_argument (cfparse_t * cfp, const char * text, int yyleng);
...
void line_change (cfparse_t * cfp, const char * text, int yyleng);
...
void do_start_cpp (cfparse_t * cfp, const char * text, int yyleng);
void do_escaped_brace (cfparse_t * cfp, const char * text, int yyleng);
void do_extern (cfparse_t * cfp, const char * text, int leng);
void do_NO_RETURN (cfparse_t * cfp, const char * text, int yyleng);
...
void do_define (cfparse_t * cfp, const char * text, int yyleng);
